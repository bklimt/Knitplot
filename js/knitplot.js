...
(function() {
  var Chart, ChartEditView, ChartListView, ChartParser, ConfirmationView, ErrorView, Graphic, Knitplot, Library, LogInView, LoggedInView, LoggedOutView, NeedToSignUpView, NotificationView, ParseErrorsView, Router, SVGPreviewView, SignUpView, SuccessView, drawCircle, drawLine, drawPolygon, drawRectangle, drawShape, drawSpline, scaleAndTranslate, scaleAndTranslatePoint,
  ...
  ChartEditView = (function(_super) {
    ...
    ChartEditView.prototype.onKeyUpText = function() {
      var text,
        _this = this;
    ...
    ChartEditView.prototype.onChangeErrors = function() {
      var _this = this;
