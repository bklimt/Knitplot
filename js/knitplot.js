...
(function() {
  var Chart, ChartParser, ErrorView, Graphic, Knitplot, Library, LoggedInView, LoggedOutView, NotificationView, PatternEditView, PatternListView, Router, drawCircle, drawLine, drawPolygon, drawRectangle, drawShape, drawSpline, scaleAndTranslate, scaleAndTranslatePoint,
  ...
  ErrorView = (function(_super) {
    ...
    ErrorView.prototype.className = "ui-state-error";
  ...
  LoggedOutView = (function(_super) {
    ...
    LoggedOutView.prototype.logIn = function() {
      return alert("What the what?");
    };

    LoggedOutView.prototype.signUp = function() {
      return $('#signup-dialog').dialog({
        height: 150,
        modal: true
      });
    };
