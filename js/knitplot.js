...
(function() {
  var ChartParser, ErrorView, Knitplot, Library, NotificationView, Pattern, PatternEditView, PatternListView, Router, drawGraphic, drawLine, drawRectangle, drawShape, makeGraphic, scaleAndTranslate,
      ...
      for (_l = 0, _len3 = row.length; _l < _len3; _l++) {
        ...
        for (rep = _m = 1, _ref = action.repetitions; 1 <= _ref ? _m <= _ref : _m >= _ref; rep = 1 <= _ref ? ++_m : --_m) {
          ...
          for (_n = 0, _len4 = _ref1.length; _n < _len4; _n++) {
            ...
            scaleAndTranslate(newShape, newShapeX, newShapeY, newShapeWidth, newShapeHeight);
