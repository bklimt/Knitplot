...
(function() {
  var Chart, ChartParser, ConfirmationView, ErrorView, Graphic, Knitplot, Library, LogInView, LoggedInView, LoggedOutView, NeedToSignUpView, NotificationView, ParseErrorsView, PatternEditView, PatternListView, Router, SVGPreviewView, SignUpView, SuccessView, drawCircle, drawLine, drawPolygon, drawRectangle, drawShape, drawSpline, scaleAndTranslate, scaleAndTranslatePoint,
  ...
  PatternEditView = (function(_super) {
    ...
    PatternEditView.prototype.onSVGButton = function() {
      var svg, url;
      svg = $("#chart").html();
    ...
    PatternEditView.prototype.onSaveButton = function() {
      var attrs, options,
        _this = this;
      if (!Parse.User.current()) {
    ...
    PatternEditView.prototype.onKeyUpTitle = function() {
      var title,
        _this = this;
      title = this.$('[name=title]').val();
    ...
    PatternEditView.prototype.onChangeTitle = function() {
      var title;
    ...
    PatternEditView.prototype.onKeyUpText = function() {
      var text,
        _this = this;
    ...
    PatternEditView.prototype.onChangeText = function() {
  ...
  PatternListView = (function(_super) {
    ...
    PatternListView.prototype.events = {
    ...
    PatternListView.prototype.onClickNew = function() {
